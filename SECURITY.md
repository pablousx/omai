...
For a vulnerability involving credential exposure, arbitrary writes, recovery corruption, or release integrity, use [GitHub private vulnerability reporting](https://github.com/pablousx/omai/security/advisories/new). Do not include exploit details, secrets, provider files, or journals in public issues.
